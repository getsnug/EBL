...
directory = "images/vaughn/"#Fill in filenames, repeat filenames to repeat images
...
with open('main.csv', mode ='r')as file:
  ...
  # displaying the contents of the CSV file
    for line in control:
        ...
        pat.size = ppi.SizeD(line[12], line[13]) # maybe change this if the image is not rectangular, 50 microns. These all set the size of the image, units unclear. the associated true size is commented in each version of this line, associated with 2k magnification
