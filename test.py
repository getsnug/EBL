...
directory = "images/"#Fill in filenames, repeat filenames to repeat images
...
with open(directory+'main.csv', mode ='r')as file:
  ...
  # displaying the contents of the CSV file
    for line in control:
        ...
        if(filename==""):
            print("reached empty line, ending loop")
            break
        ...
        size = ("size:" + str(line[12])+', '+str(line[13])) # maybe change this if the image is not rectangular, 50 microns. These all set the size of the image, units unclear. the associated true size is commented in each version of this line, associated with 2k magnification
        print(size)
        ...
        increment = line[14]
        yincrement = line[15]
        print("increments: "+str(increment)+" Y: "+str(yincrement))
        ...
        # phenom.MoveBy(-(len(exposureTimes) - 1)*increment, yincrement) # move back the increments and up a row
